...
public class ObjectFactory {
    ...
    private final static QName _DownloadResponse_QNAME = new QName("http://testwebservice1/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://testwebservice1/", "uploadResponse");
    private final static QName _Download_QNAME = new QName("http://testwebservice1/", "download");
    private final static QName _Upload_QNAME = new QName("http://testwebservice1/", "upload");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://testwebservice1/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://testwebservice1/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://testwebservice1/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://testwebservice1/", name = "upload")
